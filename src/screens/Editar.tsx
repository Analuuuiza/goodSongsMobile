...
const Editar: React.FC = () => {
    ...
    const atualizar = () => {
        ...
        axios.put('http://10.137.11.222:8000/api/musica/atualizarMusica', musica, {
            headers: {
    ...
    return (
        <View style={styles.container}>
            ...
            <View>
                ...
                <TextInput value={duracao} onChangeText={setDuracao} style={styles.input} placeholder="Duração" keyboardType="numeric" />
